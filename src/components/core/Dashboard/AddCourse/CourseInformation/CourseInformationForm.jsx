        ...
        >
            ...
            <div className=' flex flex-col space-y-2'>
                ...
                <input
                    ...
                    className='form-style text-richblack-800 px-1 w-full'
                />
                {
                    errors.courseTitle && (
            ...
            <div className=' flex flex-col space-y-2'>
                ...
                <textarea
                    ...
                    className='form-style w-full text-richblack-800 px-1  resize-x-none min-h-[130px] '
                />
                {
            ...
            <div className=' flex flex-col space-y-2'>
                ...
                <div className=' relative'>
                    <input
                        ...
                        className='form-style w-full text-richblack-800 px-1 !pl-12'
                    />
            ...
            <div className="flex flex-col space-y-2">
                ...
                <textarea
                    ...
                    className="form-style resize-x-none min-h-[130px] text-richblack-800 px-1  w-full"
                />
            ...
            <RequirementField
                ...
                error={errors}
                getValues={getValues}
                className="text-richblack-800 px-1 "
            />
